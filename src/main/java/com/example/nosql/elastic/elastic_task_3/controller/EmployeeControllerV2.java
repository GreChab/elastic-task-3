...
@Tag(name = "Employees API v2", description = "Java API Client for retrieval of employees info")
@RestController
...
public class EmployeeControllerV2 {
    ...
    public EmployeeControllerV2(@Qualifier("employeeServiceV2") EmployeeService employeeService) {
